...
export default function Challenges() {
    ...
    return (
        <Paper className={classes.root}>
            ...
            <Typography paragraph>
                The card for the "Challenges" would look like below:
            </Typography>
            <div className={classes.paraG}>
                <Card className={classes.card}>
                    <CardActionArea>
                        ...
                        height="150"
                        image="https://wwwgrabcraftcom-jzoul76nauwdp2hxnkfs.stackpathdns.com/files/products/large/large_helicopter-1-1095.png"
                        ...
                        <CardContent>
                            ...
                            <Typography gutterBottom component="h6">
                                Have you ever thought of a helicopter moving around your world?
                                Challenge yourself and make it into reality...
                            </Typography>
                            <Typography component="h6" className={classes.letter}>
                                Challenges / Command Blocks
                            </Typography>
                        </CardContent>
                    </CardActionArea>
